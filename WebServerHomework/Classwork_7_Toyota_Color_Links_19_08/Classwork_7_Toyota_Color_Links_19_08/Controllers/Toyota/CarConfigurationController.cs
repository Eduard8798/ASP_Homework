...
namespace Classwork_7_Toyota_Color_Links_19_08.Controllers.Toyota
{
    public class CarConfigurationController : Controller
    {
        ...
        {
            ViewData["ModelId"] = new SelectList(_context.Toyota, "Id", "Name");
            return View();
        }
        ...
        {
            configurationModel.Model = _context.Toyota.Find(configurationModel.ModelId);
            
                _context.Add(configurationModel);
                await _context.SaveChangesAsync();
                return RedirectToAction(nameof(Index));
            
            ViewData["ModelId"] = new SelectList(_context.Toyota, "Id", "Name", configurationModel.ModelId);
            return View(configurationModel);
        }
